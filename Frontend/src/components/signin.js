      ...
      <PageContainer>
        <SignInContainer>
          ...
          <form action="http://localhost:8001/check-user" method="get">
            ...
            <SignInButton type="button" onClick={handleSignUp}>Sign up</SignInButton>
            {/* <ResetLink href="/CreateUser">Reset Password</ResetLink> */}
          </form>
          <ResetLink href="/ResetPassword">Reset Password</ResetLink>
        </SignInContainer>
      </PageContainer>
    );
  };
